...
globalThis.bytebeat = new class {
	...
	async init() {
		...
		if (!window.location.hostname.includes`gfljs2100-user`&&!window.location.hostname.includes`gfljbeat2`) { // You may also change this line to your hostname. (instead of `chasyxx`, use `t-8492` for example)
